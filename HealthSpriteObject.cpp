...
void HealthSpriteObject::Init()
{
    ...
    MeshFactory::CreateQuad2D(mf, { 50.0f, 50.0f, true });
    ...
    ID3D11ShaderResourceView* srv = Texture::LoadAndRegisterKey("assets\\texture\\health.png");
...
void HealthSpriteObject::Update(float gameDt, float realDt)
{
