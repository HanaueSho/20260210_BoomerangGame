...
void AimSpriteObject::Init()
{
    ...
    MeshFactory::CreateQuad2D(mf, { 200.0f, 200.0f, true });
    ...
    ID3D11ShaderResourceView* srv = Texture::LoadAndRegisterKey("assets\\texture\\aimTexture_002.png");
