...
void MarkSpriteObject::Init()
{
    ...
    MeshFactory::CreateQuad2D(mf, { 20.0f, 20.0f, true });
    ...
    ID3D11ShaderResourceView* srv = Texture::LoadAndRegisterKey("assets\\texture\\targetTexture_003.png");
