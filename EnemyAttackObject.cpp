...
void EnemyAttackObject::Init()
{
	...
	//MeshFactory::CreateSphere(mf, { 1, 16, 16 });
	...
	// DamageComponent
	auto* damage = AddComponent<DamageComponent>();
	damage->Init();
}
